...
'''TEST_CASE_3: Null/None as Input: This test takes in array with None as input type, 
and run them against sorting algorithm. Sorting algorithm should return an array with Null/None '''
def test_sorting_on_null():
    items = [None]
    expected = [None]
    assert quick_sort(items) == expected

'''TEST_CASE_4: Array of repeated positive integers as input, quick_sort should sort this array in ascending order '''
@pytest.mark.parametrize(
    "items,expected",
    [
...
'''TEST_CASE_5: Array of mix of positive and negative integers as input, quick_sort should sort this array in ascending order '''
@pytest.mark.parametrize(
    "items,expected",
    [
...
'''TEST_CASE_6: Array of only negative integers as input, quick_sort should sort this array in ascending order '''
@pytest.mark.parametrize(
    "items,expected",
    [
...
'''TEST_CASE_7: Array of mix of floating points and integers as input, quick_sort should sort this array in ascending order '''
@pytest.mark.parametrize(
    "items,expected",
    [
...
'''TEST_CASE_8: Array of mix of floating points,positive and negative integers as input, quick_sort should sort this array in ascending order '''
@pytest.mark.parametrize(
    "items,expected",
    [
...
'''TEST_CASE_9: Array of characters as input, quick_sort should sort this array in ascending order '''
@pytest.mark.parametrize(
    "items,expected",
    [
...
'''TEST_CASE_10: Array of characters with repeated elements as input, quick_sort should sort this array in ascending order '''
@pytest.mark.parametrize(
    "items,expected",
    [
...
'''TEST_CASE_11: Array of words as input, quick_sort should sort this array in ascending order '''
@pytest.mark.parametrize(
    "items,expected",
    [
...
'''TEST_CASE_12: Immutable Tuple test: This test takes in random tuple as input type generated by random function, 
...
'''TEST_CASE_13: Immutable String test: This test takes in random string as input types generated by random function, 
number of elements in the array is defined by the range function and run them against sorting algorithm. 
...
def test_sort_on_random_string():
    ...
    print(items1)
    sorted_items = quick_sort(items1)  #sort() function trying to sort the immutable string object
    with pytest.raises(AttributeError):  #we expect code will raise an exception, pytest handles this exception here
        raise_exception()



'''TEST_CASE_14: Non-Comparable Collection test: This test takes in array of mix of ints and strings as input types, 
